...
CREATE TABLE Realties (id bigint(20) NOT NULL AUTO_INCREMENT, user_id bigint(20) NOT NULL, realty_category_id bigint(20) NOT NULL, town_id bigint(20) NOT NULL, description text, price double NOT NULL, quantity int(15) DEFAULT 1, orders_number int(20), type varchar(100) NOT NULL, status tinyint DEFAULT 1 NOT NULL comment '0 = blocked
1 = available
