CREATE TABLE Applies (user_id bigint(20) NOT NULL, apply_id bigint(20) NOT NULL, CONSTRAINT id PRIMARY KEY (user_id, apply_id));
...
CREATE TABLE Groups (id bigint(20) NOT NULL AUTO_INCREMENT, roles_id bigint(20), name_en varchar(100) NOT NULL, name_fr varchar(100), CONSTRAINT id PRIMARY KEY (id));
CREATE TABLE Groups_Users (group_id bigint(20) NOT NULL, user_id bigint(20) NOT NULL, PRIMARY KEY (group_id, user_id));
CREATE TABLE Languages (id bigint(20) NOT NULL AUTO_INCREMENT, code varchar(10) NOT NULL, country varchar(255) NOT NULL, description text, created_at datetime NOT NULL, CONSTRAINT id PRIMARY KEY (id));
...
CREATE TABLE Medias (id bigint(20) NOT NULL AUTO_INCREMENT, user_id bigint(20) NOT NULL, reality_id bigint(20), media_type_id bigint(20) NOT NULL, name varchar(255) NOT NULL, link varchar(255) NOT NULL, type varchar(10) NOT NULL, `size` varchar(255) NOT NULL, delete_integrity tinyint DEFAULT 0 NOT NULL, created_at datetime NOT NULL, PRIMARY KEY (id));
CREATE TABLE Password_resets (email varchar(255) NOT NULL, token varchar(255) NOT NULL, created_at datetime NOT NULL);
...
CREATE TABLE Realities (id bigint(20) NOT NULL AUTO_INCREMENT, user_id bigint(20) NOT NULL, apply_category_id bigint(20) NOT NULL, town_id bigint(20) NOT NULL, description text, price double NOT NULL, quantity int(15) DEFAULT 1, orders_number int(20), type varchar(100) NOT NULL, status tinyint DEFAULT 1 NOT NULL comment '0 = blocked
1 = available
2 = sold', delete_integrity tinyint DEFAULT 0 NOT NULL, created_at datetime NOT NULL, updated_at datetime NULL, PRIMARY KEY (id));
CREATE TABLE Reality_categories (id bigint(20) NOT NULL AUTO_INCREMENT, name varchar(160) NOT NULL, description text, created_at datetime NOT NULL, CONSTRAINT id PRIMARY KEY (id));
...
ALTER TABLE Users ADD CONSTRAINT FKUsers491114 FOREIGN KEY (language_id) REFERENCES Languages (id) ON UPDATE Restrict ON DELETE Restrict;
ALTER TABLE Groups ADD CONSTRAINT FKGroups842411 FOREIGN KEY (roles_id) REFERENCES Roles (id) ON UPDATE Restrict ON DELETE Restrict;
...
ALTER TABLE Realities ADD CONSTRAINT FKRealities693319 FOREIGN KEY (user_id) REFERENCES Users (id) ON UPDATE Restrict ON DELETE Restrict;
ALTER TABLE Medias ADD CONSTRAINT FKMedias543575 FOREIGN KEY (reality_id) REFERENCES Realities (id) ON UPDATE Restrict ON DELETE Restrict;
...
ALTER TABLE Applies ADD CONSTRAINT FKApplies771577 FOREIGN KEY (apply_id) REFERENCES Realities (id) ON UPDATE Restrict ON DELETE Restrict;
ALTER TABLE Realities ADD CONSTRAINT FKRealities947106 FOREIGN KEY (apply_category_id) REFERENCES Reality_categories (id) ON UPDATE Restrict ON DELETE Restrict;
...
ALTER TABLE Groups_Users ADD CONSTRAINT FKGroups_Use488232 FOREIGN KEY (group_id) REFERENCES Groups (id);
...
ALTER TABLE Realities ADD CONSTRAINT FKRealities150751 FOREIGN KEY (town_id) REFERENCES Towns (id);
